...
(* OASIS_START *)
(* DO NOT EDIT (digest: a76a47c3afa94a5e2f845d13b0e7dcc7) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("ppx_meta_conv", None);
                      ...
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt =
                        [(OASISExpr.EBool true, ["-g"; "-w"; "+a"; "-annot"])
                        ];
                      bs_nativeopt =
                        [(OASISExpr.EBool true, ["-g"; "-w"; "+a"; "-annot"])
                        ]
     ...
     oasis_digest = Some "\209\129&\252\209\227\017\016m\197\tB)T\217\128";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
